...
HD_PWD='C:/Users/Om Patel/Desktop/arty-conv-accelerator/vivado_project_m4/arty_conv_m4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arty_m4_ethernet_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arty_m4_ethernet_top.tcl
