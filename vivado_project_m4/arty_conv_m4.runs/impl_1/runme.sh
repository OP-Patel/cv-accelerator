...
HD_PWD='C:/Users/Om Patel/Desktop/arty-conv-accelerator/vivado_project_m4/arty_conv_m4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arty_m4_ethernet_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arty_m4_ethernet_top.tcl -notrace
